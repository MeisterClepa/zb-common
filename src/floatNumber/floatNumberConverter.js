...
cnv.floatNumberWordsDelimetedConverter = function(parseTree) {
    ...
    if (parseTree.Minus) {
        res = (-1) * parseFloat(parseTree.IntegerNumber[0].value) - parseFloat(fraction);
    } else {
...
cnv.floatNumberPropagateConverter = function(parseTree) {
...
cnv.floatNumberConverterNegativeText = function(parseTree) {
    var res = (-1) * parseFloat(parseTree.FloatNumberNonNegative[0].value);
    return res;
};