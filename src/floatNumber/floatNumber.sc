...
patterns:
    ...
    $floatNumberWordsDelimeted = ([$Minus] $Number::IntegerNumber (цел*|запятая|и) [и] ([$Minus] $Number::FractionalNumber [$FloatNumberFraction]| $fractionWithDelimeter) | 
    ...
    $numberAndHalf = [$Minus] $Number (с половиной/and [a|one] half) || converter = $converters.numberAndHalfConverter
    ...
    $FloatNumber = [$Minus] ($floatNumberWordsDelimeted|$floatNumberWithDelimeter|$specialFloatNumber|$Fraction) || converter = $converters.floatNumberPropagateConverter
